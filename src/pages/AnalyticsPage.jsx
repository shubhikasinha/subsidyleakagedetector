        ...
        <div className="min-h-screen bg-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                            <img src="/logojan.jpeg" alt="JanAvlokan Logo" className="h-14 w-auto" />
                            <div>
            ...
            <section className="pb-6">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid lg:grid-cols-2 gap-6">
                        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                            <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                <h3 className="font-heading font-semibold text-gray-900">Monthly Trend</h3>
                            </div>
                            <div className="p-4">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                            <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                                <h3 className="font-heading font-semibold text-gray-900">Scheme-wise Cases</h3>
                            </div>
                            <div className="p-4">
                                <ResponsiveContainer width="100%" height={250}>
            ...
            <section className="pb-6">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                        <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                            <h3 className="font-heading font-semibold text-gray-900">State-wise Analysis</h3>
                        </div>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Beneficiaries</th>
                                        <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Flagged</th>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-500">Advisory-only system</span>
                        </div>
